...
export default function FormPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center items-center bg-no-repeat bg-fixed bg-cover" style={{backgroundImage: "url(/back.webp)"}}>
      ...
      {submitting && (
        <div className="bg-white p-8 rounded-lg shadow-md animate-fade-in bg-no-repeat bg-contain  bg-fixed" style={{backgroundImage: "url(/Sharingan.webp)", backgroundPosition: 'center', backgroundSize: "20%"}} >
