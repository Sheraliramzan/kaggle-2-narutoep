...
export default function FormPage() {
  ...
  return (
    <div className="min-h-screen className={`w-full h-full bg-cover bg-fixed bg-no-repeat bg-center bg-[url('/back.webp')]flex justify-center items-center">
         <Head>
        <title>LOGIN</title>
      ...
      <div className={`bg-yellow-100 p-8 rounded-lg shadow-md ${submitting ? 'animate-fade-out' : ''}`}>
